...
class SignupGroupBox(StyledGroupBox):
    ...
    def setupUI(self):
        ...
        terms_layout.addWidget(terms_text, 1)
        ...
        login_text.setStyleSheet("color: #1976D2; font-size: 14px;")  # Bleu moyen
...
class SignupWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("BizTrack360")
        ...
        # Groupbox d'inscription
        self.signup_box = SignupGroupBox(self.gradient_widget)
        main_layout.addWidget(self.signup_box, 1)
